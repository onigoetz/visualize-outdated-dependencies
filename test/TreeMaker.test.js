...
function loadFixture(name) {
	...
	return lockfile.parse(contents).object;
}
...
describe("getTree with yarn workspaces", () => {
	const currentDir = fileURLToPath(
		new URL("./fixtures/workspace-repo", import.meta.url),
	);
	...
	function workspaceTree() {
		...
		return makeTree("workspace-repo", rootPackage, { currentDir });
	}
